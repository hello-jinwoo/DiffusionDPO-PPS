...
class Selector:
    def __init__(self, device: str) -> None:
        ...
        if not os.path.exists(checkpoint_path):
            logger.info("Downloading HPS_v2_compressed.pt...")
            ...
            with open(os.path.join(root_path, "HPS_v2_compressed.pt"), "wb") as HPSv2:
                ...
                for chunk in progress.bar(
                    ...
                    if chunk:
                        HPSv2.write(chunk)
                        HPSv2.flush()
            logger.info(f"Downloaded HPS_v2_compressed.pt to {root_path}/ successfully")

        logger.info("Loading HPS model...")
        ...
        model.eval()
        self.model = model
        logger.info("HPS model loaded successfully")

    def score(
        self, img_path: Union[str, List[str], Image.Image, List[Image.Image]], prompt: str
